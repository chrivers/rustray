...
fn draw_image<F: Float, B: FiniteGeometry<F>, G: Geometry<F>, L: Light<F>>(time: &mut TimeSlice, tracer: Tracer<F, B, G, L>, width: u32, height: u32) -> RResult<ImageBuffer<Rgb<u8>, Vec<u8>>>
{
